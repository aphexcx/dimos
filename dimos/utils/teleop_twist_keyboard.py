...
class PublishThread(threading.Thread):
    def __init__(self, rate, topic_name, stamped=False, frame_id=""):
        ...
        # Use LCMTransport instead of raw lcm.LCM()
        if stamped:
            self.transport = LCMTransport(topic_name, TwistStamped)
        else:
            self.transport = LCMTransport(topic_name, Twist)
