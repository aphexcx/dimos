...
"""Refactored OpenAI agent implementation using the new abstraction layer."""
...
from dimos.agents.providers.openai_provider import OpenAIProvider
...
logger = setup_logger("dimos.agents.refactored_openai")


class RefactoredOpenAIAgent(BaseLLMAgent):
    """Refactored OpenAI agent using the new abstraction layer."""
    ...
    def __init__(
        ...
        self.llm_provider = OpenAIProvider(
            ...
            tokenizer=tokenizer or OpenAITokenizer(model_name=model_name),
            max_tokens=max_output_tokens_per_request,
        )

        # Initialize prompt builder and tokenizer
        ...
        logger.info("Refactored OpenAI Agent Initialized.")
