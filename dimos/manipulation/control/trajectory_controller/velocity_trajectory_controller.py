...
class VelocityTrajectoryController(Module):
    ...
    default_config = VelocityTrajectoryControllerConfig
    config: VelocityTrajectoryControllerConfig  # Type hint for proper attribute access
